...
class TestTamagotchi(unittest.TestCase):
    ...
    def testNaoConsegueDormir(self):
        ...
        self.assertTrue(tamagotchi.comer(),
                        "Deve ser possivel o tamagotchi comer se ele nao tiver morrido.")
[15:16, 14/11/2022] Cauã Brandão: self.assertFalse(tamagotchi.dormir(),
...
[15:16, 14/11/2022] Cauã Brandão: self.assertFalse(tamagotchi.getEstaVivo(),
...
[15:16, 14/11/2022] Cauã Brandão: self.assertEqual(2, tamagotchi.getDiamantes(),
